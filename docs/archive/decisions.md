...
- Detailed decision log: [`docs/archive/decisions_planning_grid_threshold.md`](decisions_planning_grid_threshold.md)
...
- Detailed decision log: [`docs/archive/decisions_control_drone_trajectory.md`](decisions_control_drone_trajectory.md)
...
- Detailed decision log: [`docs/archive/decisions_control_drone_trajectory_pass_through.md`](decisions_control_drone_trajectory_pass_through.md)
...
- Detailed decision log: [`docs/archive/decisions_control_drone_trajectory_pass_through_accel.md`](decisions_control_drone_trajectory_pass_through_accel.md)
...
- Detailed decision log: [`docs/archive/decisions_control_drone_trajectory_pass_through_accel_jerk.md`](decisions_control_drone_trajectory_pass_through_accel_jerk.md)
...
- Detailed decision log: [`docs/archive/decisions_control_drone_trajectory_coupled_continuity.md`](decisions_control_drone_trajectory_coupled_continuity.md)
...
- Detailed decision log: [`docs/archive/decisions_control_drone_trajectory_coupled_continuity_controllers.md`](decisions_control_drone_trajectory_coupled_continuity_controllers.md)
...
- Detailed decision log: [`docs/archive/decisions_control_drone_trajectory_noncoupled_controllers.md`](decisions_control_drone_trajectory_noncoupled_controllers.md)
...
- Detailed decision log: [`docs/archive/decisions_control_drone_trajectory_controller_generator_pairings.md`](decisions_control_drone_trajectory_controller_generator_pairings.md)
