...
- `control-drone-trajectory-variants`: [`docs/archive/experiments_control_drone_trajectory.md`] + [`docs/archive/decisions_control_drone_trajectory.md`]
- `control-drone-trajectory-pass-through`: [`docs/archive/experiments_control_drone_trajectory_pass_through.md`] + [`docs/archive/decisions_control_drone_trajectory_pass_through.md`]
- `control-drone-trajectory-pass-through-accel`: [`docs/archive/experiments_control_drone_trajectory_pass_through_accel.md`] + [`docs/archive/decisions_control_drone_trajectory_pass_through_accel.md`]
- `control-drone-trajectory-pass-through-accel-jerk`: [`docs/archive/experiments_control_drone_trajectory_pass_through_accel_jerk.md`] + [`docs/archive/decisions_control_drone_trajectory_pass_through_accel_jerk.md`]
- `control-drone-trajectory-coupled-continuity`: [`docs/archive/experiments_control_drone_trajectory_coupled_continuity.md`] + [`docs/archive/decisions_control_drone_trajectory_coupled_continuity.md`]
- `control-drone-trajectory-coupled-continuity-controllers`: [`docs/archive/experiments_control_drone_trajectory_coupled_continuity_controllers.md`] + [`docs/archive/decisions_control_drone_trajectory_coupled_continuity_controllers.md`]
- `control-drone-trajectory-noncoupled-controllers`: [`docs/archive/experiments_control_drone_trajectory_noncoupled_controllers.md`] + [`docs/archive/decisions_control_drone_trajectory_noncoupled_controllers.md`]
- `control-drone-trajectory-controller-generator-pairings`: [`docs/archive/experiments_control_drone_trajectory_controller_generator_pairings.md`] + [`docs/archive/decisions_control_drone_trajectory_controller_generator_pairings.md`]
...
- `planning-grid-threshold-planners`: [`docs/archive/experiments_planning_grid_threshold.md`] + [`docs/archive/decisions_planning_grid_threshold.md`]
