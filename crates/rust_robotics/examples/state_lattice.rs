...
use rust_robotics::planning::state_lattice::{StateLattice, StateLatticeConfig};
use rust_robotics::prelude::*;
use rust_robotics::viz::{colors, PathStyle, PointStyle, Visualizer};
...
fn test_lane_sampling() {
    ...
    for y_offset in [-lane_width / 2.0, lane_width / 2.0] {
        ...
        let lane_path = Path2D::from_points(lane_points);
        vis.plot_path(
            &lane_path,
