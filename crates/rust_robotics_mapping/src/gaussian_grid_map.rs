...
pub const XY_RESOLUTION: f64 = 0.5;
/// Default standard deviation for the Gaussian kernel.
pub const STD: f64 = 5.0;
...
/// Build an SVG visualization of the Gaussian grid map.
pub fn build_gaussian_grid_map_svg(grid_map: &GaussianGridMap, ox: &[f64], oy: &[f64]) -> String {
    let width = 920.0;
    let height = 700.0;
    let margin = 72.0;
...
/// Save a Gaussian grid map SVG to a file.
pub fn save_gaussian_grid_map_svg(
    filename: &str,
