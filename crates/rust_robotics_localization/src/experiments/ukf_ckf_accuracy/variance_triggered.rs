use super::{AccuracyAggregationVariant, AccuracySamplingPlan, VariantDescriptor};

#[derive(Debug, Clone)]
pub struct VarianceTriggeredAccuracyAggregation {
    initial_slots: Vec<usize>,
    ratio_margin_threshold: f64,
}

impl VarianceTriggeredAccuracyAggregation {
...
impl AccuracyAggregationVariant for VarianceTriggeredAccuracyAggregation {
    fn descriptor(&self) -> VariantDescriptor {
        VariantDescriptor {
            ...
            source_path: concat!(
                ...
                "/src/experiments/ukf_ckf_accuracy/variance_triggered.rs"
            ),
            knob_count: 2,
